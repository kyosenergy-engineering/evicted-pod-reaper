module github.com/kyosenergy-engineering/evicted-pod-reaper
...
// Force all structured-merge-diff dependencies to use v4 for compatibility
replace sigs.k8s.io/structured-merge-diff/v6 => sigs.k8s.io/structured-merge-diff/v4 v4.4.1

// Use compatible kube-openapi version that works with v4
